--Query A2: Enter a query using a sub-select to retrieve all employees whose salary is greater than the average salary
...
SELECT F_NAME, DEP_NAME FROM EMPLOYEES E, DEPARTMENTS D WHERE D.DEPT_ID_DEP = E.DEP_ID
